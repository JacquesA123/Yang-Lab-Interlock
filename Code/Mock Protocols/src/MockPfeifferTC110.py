# Mock PfeifferTC110 (difference with non-Mock program is that this one is not time-dependent, but can be called from another time-dependent program)
# Need to fix the get speed and get current functions to non-mock once connected to the real pump
...
class TC110:
    ...
    def get_pressure(self, device_id=None):        
        ...
        if message:
            ...
            return None
# Edited the get speed function to return a mock value
    ...
    def get_power(self, device_id=None):
        ...
        if message:
            ...
            return None
# Edited the get current function to return a mock value
